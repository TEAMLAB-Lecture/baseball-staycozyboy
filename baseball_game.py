...
def is_between_100_and_999(user_input_number):
    ...
    # ==================================
    return (result >= 100 and result <= 999)
...
def is_duplicated_number(three_digit):
    ...
    result = False
    first, second, third = list(str(three_digit))
...
def is_validated_number(user_input_number):
    ...
    result = is_digit(user_input_number) and is_between_100_and_999(int(user_input_number)) and not is_duplicated_number(int(user_input_number))
    # ==================================
    return result
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    for input_digit, random_digit in zip(user_input_number, random_number):
        if input_digit == random_digit:
            result[0] += 1
        else:
            trimmed_number += random_digit

    for input_digit in user_input_number:
        if input_digit in trimmed_number:
            result[1] += 1
    # ==================================
    return result
